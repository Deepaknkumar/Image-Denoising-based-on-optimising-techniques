...
for i=1:4
    tempnf = coefflev1(i,:);
    tempn = ncoefflev1(i,:);
    [mcoefflev1(i,:),mselev1(i,:),psnrlev1(i,:)] = dssc4(method,@add,[],n,dimensions,lower_limit,upper_limit,maxIter,tempnf,tempn,nsd);
end
...
for i=1:3
    tempnf = coefflev2(i,:);
    tempn = ncoefflev2(i,:);
    [mcoefflev2(i,:),mselev2(i,:),psnrlev2(i,:)] = dssc4(method,@add,[],n,dimensions,lower_limit,upper_limit,maxIter,tempnf,tempn,nsd);
end
