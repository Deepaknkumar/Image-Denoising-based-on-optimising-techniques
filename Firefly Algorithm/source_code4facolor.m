...
for i=1:4
    tempnf = rcoefflev1(i,:);
    tempn = rncoefflev1(i,:);
    [rmcoefflev1(i,:),rnestlev1(:,:,i)] = fireflysc4(n,tempnf,tempn,nsd);
end
...
for i=1:3
    tempnf = rcoefflev2(i,:);
    tempn = rncoefflev2(i,:);
    [rmcoefflev2(i,:),rnestlev2(:,:,i)] = fireflysc4(n,tempnf,tempn,nsd);
end
...
for i=1:4
    tempnf = gcoefflev1(i,:);
    tempn = gncoefflev1(i,:);
    [gmcoefflev1(i,:),gnestlev1(:,:,i)] = fireflysc4(n,tempnf,tempn,nsd);
end
...
for i=1:3
    tempnf = gcoefflev2(i,:);
    tempn = gncoefflev2(i,:);
    [gmcoefflev2(i,:),gnestlev2(:,:,i)] = fireflysc4(n,tempnf,tempn,nsd);
end
...
for i=1:4
    tempnf = bcoefflev1(i,:);
    tempn = bncoefflev1(i,:);
    [bmcoefflev1(i,:),bnestlev1(:,:,i)] = fireflysc4(n,tempnf,tempn,nsd);
end
...
for i=1:3
    tempnf = bcoefflev2(i,:);
    tempn = bncoefflev2(i,:);
    [bmcoefflev2(i,:),bnestlev2(:,:,i)] = fireflysc4(n,tempnf,tempn,nsd);
end
