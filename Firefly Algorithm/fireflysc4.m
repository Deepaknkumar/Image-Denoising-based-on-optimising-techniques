...
function [mxr,bnvalues] = fireflysc4(num,y,xr,nsd)
...
[u,fval,NumEval,bnvalues]=ffa_mincon(@fitnessfuncsc4,u0,Lb,Ub,para,xr,y);
...
% Start FA
function [nbest,fbest,NumEval,bnvalues]...
           =ffa_mincon(fhandle,u0, Lb, Ub, para,xr,y)
