...
%%
function [ mxr,bnvalues] = Particle_Swarm_Optimizationsc6(Bird_in_swarm, Number_of_quality_in_Bird, MinMaxRange, Food_availability, availability_type, velocity_clamping_factor, cognitive_constant, social_constant, Min_Inertia_weight, Max_Inertia_weight, max_iteration,yn,xr)
...
for itr=1:max_iteration
    ...
    for p=1:Bird_in_swarm
        ...
        availability(p,itr)=fitnessfuncsc6(parameter,xr,yn);
