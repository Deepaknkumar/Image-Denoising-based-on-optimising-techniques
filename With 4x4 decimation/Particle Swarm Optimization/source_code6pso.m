...
for i=1:4
    tempnf = coefflev1(i,:);
    tempn = ncoefflev1(i,:);
    [mcoefflev1(i,:),nestlev1(:,:,i)] = Particle_Swarm_Optimizationsc6(n,nv,lim,@add,'min',vcf,cc,sc,miniw,maxiw,num,tempnf,tempn);
end
...
for i=1:3
    tempnf = coefflev2(i,:);
    tempn = ncoefflev2(i,:);
    [mcoefflev2(i,:),nestlev2(:,:,i)] = Particle_Swarm_Optimizationsc6(n,nv,lim,@add,'min',vcf,cc,sc,miniw,maxiw,num,tempnf,tempn);
end
