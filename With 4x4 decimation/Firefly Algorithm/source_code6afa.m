...
for i=1:4
    ...
    for j=1:numdec1
        ...
        [mcoefflev1(i,((j-1)*numelem)+1:j*numelem),nestlev1(:,:,i)] = fireflysc6(n,tempnf,tempn,nsd);
    end
...
for i=1:3
    ...
    for j=1:numdec2
        ...
        [mcoefflev2(i,((j-1)*numelem)+1:j*numelem),nestlev2(:,:,i)] = fireflysc6(n,tempnf,tempn,nsd);
    end
