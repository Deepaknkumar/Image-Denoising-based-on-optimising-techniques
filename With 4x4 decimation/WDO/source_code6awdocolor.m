...
for i=1:4
    ...
    for j=1:rnumdec1
        ...
        [rmcoefflev1(i,((j-1)*numelem)+1:j*numelem),rnestlev1(:,:,i)] = wdosc6(n,tempnf,tempn,nsd);
    end
...
for i=1:3
    ...
    for j=1:rnumdec2
        ...
        [rmcoefflev2(i,((j-1)*numelem)+1:j*numelem),rnestlev2(:,:,i)] = wdosc6(n,tempnf,tempn,nsd);
    end
...
for i=1:4
    ...
    for j=1:gnumdec1
        ...
        [gmcoefflev1(i,((j-1)*numelem)+1:j*numelem),gnestlev1(:,:,i)] = wdosc6(n,tempnf,tempn,nsd);
    end
...
for i=1:3
    ...
    for j=1:gnumdec2
        ...
        [gmcoefflev2(i,((j-1)*numelem)+1:j*numelem),gnestlev2(:,:,i)] = wdosc6(n,tempnf,tempn,nsd);
    end
...
for i=1:4
    ...
    for j=1:bnumdec1
        ...
        [bmcoefflev1(i,((j-1)*numelem)+1:j*numelem),bnestlev1(:,:,i)] = wdosc6(n,tempnf,tempn,nsd);
    end
...
for i=1:3
    ...
    for j=1:bnumdec2
        ...
        [bmcoefflev2(i,((j-1)*numelem)+1:j*numelem),bnestlev2(:,:,i)] = wdosc6(n,tempnf,tempn,nsd);
    end
