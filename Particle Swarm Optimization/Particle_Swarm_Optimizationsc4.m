...
%%
function [ mxr,bnvalues] = Particle_Swarm_Optimizationsc2(Bird_in_swarm, Number_of_quality_in_Bird, MinMaxRange, Food_availability, availability_type, velocity_clamping_factor, cognitive_constant, social_constant, Min_Inertia_weight, Max_Inertia_weight, max_iteration,yn,xr)
%Food_availability = fitnessfunc;
%{
...
for itr=1:max_iteration
    ...
    for p=1:Bird_in_swarm
        ...
        availability(p,itr)=fitnessfuncsc4(parameter,xr,yn);
